  ...
  prompt: {
    types: [
      ...
      },
      {
        value: 'build',
        name: '🚚构建：影响构建系统或外部依赖',
        description: 'build: 构建'
      },
      {
        value: 'chore',
        name: '🔨工具：更改构建流程或辅助工具',
        description: 'chore: 杂项'
      },
      {
        value: 'revert',
        name: '👈回滚：代码回滚',
        description: 'revert: 回滚'
      }
      // {
    ...
    scopes: ['root', 'frontend', 'backend', 'components', 'utils', 'config', 'docs', 'tests'],
